...
public class FileDialogActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.selectButton.setOnClickListener(new View.OnClickListener() { // from class: com.ascon.subdivformer.FileDialogActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                if (FileDialogActivity.this.selectedFile != null) {
                    FileDialogActivity.this.getIntent().putExtra("RESULT_PATH", FileDialogActivity.this.selectedFile.getPath());
    ...
    private void getDirImpl(String dirPath) {
        ...
        for (File file : files) {
            ...
            } else if (GetFileExt(file.getName()).compareToIgnoreCase("sdf") == 0 || GetFileExt(file.getName()).compareToIgnoreCase("om") == 0 || GetFileExt(file.getName()).compareToIgnoreCase("ply") == 0) {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (file.isDirectory()) {
            ...
            new AlertDialog.Builder(this).setIcon(R.drawable.icon).setTitle("[" + file.getName() + "] " + ((Object) getText(R.string.cant_read_folder))).setPositiveButton("OK", new DialogInterface.OnClickListener() { // from class: com.ascon.subdivformer.FileDialogActivity.2
